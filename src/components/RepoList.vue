  ...
  <main class="py-10 min-w-[80%] space-y-4 dark:bg-gray-900 bg-[#B3D5F2]/20 px-8 lg:px-44">
    ...
    >
      <button
        ...
        class="px-3 py-1 mx-1 bg-[#4AA2D9] dark:bg-gray-700 text-white rounded"
      >
        Prev
      </button>
      <div class="flex space-x-1">
        <button
          ...
          @click="goToPage(page)"
          :class="{
            'bg-[#4AA2D9]/70 text-white dark:bg-gray-600': currentPage === page,
      ...
      <button
        ...
        class="px-3 py-1 mx-1 bg-[#4AA2D9] text-white dark:bg-gray-700 rounded"
      >
        Next
      </button>
    </nav>
